...
//    private ImageButton btnProfile;
    ...
    public static final String TAG = "ComponentFragment";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        this.btnCaptureImage = view.findViewById(R.id.btnCaptureImage);
        this.btnSubmit = view.findViewById(R.id.btnSubmit);
        this.etDescription = view.findViewById(R.id.etDescription);
        this.ivPostImage = view.findViewById(R.id.ivPostImage);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                // by this point we have the camera photo on disk -> decode the file
